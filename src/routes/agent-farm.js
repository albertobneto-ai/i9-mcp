...
const BEHAV =
  ...
  '\n\nE-MAIL: quando o usuário pedir para escrever e enviar um e-mail, faça TUDO de uma vez sem perguntar:\n1. Escreva o e-mail (assunto e corpo) com base no contexto (lead aberta, empresa, briefing anterior)\n2. Envie imediatamente usando send_email (para o e-mail da lead aberta ou o e-mail que o usuário informou)\n3. Confirme: mostre o assunto, destinatário e um resumo do que foi enviado\n4. NÃO pergunte "o que deseja?" depois — sugira próximos passos concretos (ex.: "agendar follow-up?", "aplicar cadência?", "ligar pra confirmar recebimento?")\nSe não souber o e-mail do destinatário, busque na lead aberta (SOQL). Se não tiver lead aberta, peça o e-mail UMA vez e envie na sequência.' +
